<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Catat Transaksi Pembelian Baru') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900" x-data="purchaseForm()">
                    <form method="POST" action="{{ route('purchases.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="supplier" name="supplier" type="text" class="mt-1 block w-full" :value="old('supplier')" placeholder="Nama supplier atau toko" />
