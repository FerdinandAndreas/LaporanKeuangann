...
<head>
    ...
    <title>Nota Penjualan Gabungan</title>
    <style>
        :root {
            --invoice-blue: #0b3fa8;
            --border-blue: #5b8df5;
...
<body>
    ...
    <div class="invoice-card" id="invoice-sheet">
        ...
        <div class="customer-section">
            ...
            <span class="customer-name-underline">{{ $buyer }}</span>
        </div>
        ...
        <table class="items-table">
            ...
            <tbody>
                <!-- Active Row: The sale transaction items -->
                ...
                <!-- Dynamic Blank Rows to total exactly 8 or more -->
                @php
                    $blankRows = max(0, 8 - count($sales));
                @endphp
    ...
    <script>
        function downloadPNG() {
            ...
            html2canvas(sheet, options).then(canvas => {
                ...
                link.download = 'Nota_Gabungan_Penjualan.png';
